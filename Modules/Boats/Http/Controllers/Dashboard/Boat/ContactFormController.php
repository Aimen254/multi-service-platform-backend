...
class ContactFormController extends Controller
{
    ...
    public function index($moduleId, $businessUuid)
    {
        ...
        return Inertia::render('Boats::ContactForm/Index', [
            'forms' => $forms,
     ...
     * @return Renderable
     */
    public function show($moduleId, $businessUuid, ContactForm $contactForm)
    {
        return Inertia::render('Boats::ContactForm/Show', [
    ...
    public function destroy($moduleId, $businessUuid, ContactForm $contactForm,Request $request)
    {
        try {
            ...
            if ($currentCount > 1) {
                ...
                return Redirect::route('boats.dashboard.dealership.contact-form.index', [$moduleId,$businessUuid, 'page' => $previousPage]);
            }
