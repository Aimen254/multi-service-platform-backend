                        ...
                        <tbody v-if="contactForms && contactForms.data.length > 0">
                            <template v-for="form in contactForms.data" :key="form.id">
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <view-section permission="view_contact_form" :url="route('boats.dashboard.dealership.contact-form.show', [getSelectedModuleValue(), getSelectedBusinessValue(), form.id])"/>
                                            ...
                                            <delete-section permission="delete_contact_form"
                                                :url="route('boats.dashboard.dealership.contact-form.destroy', [getSelectedModuleValue(), getSelectedBusinessValue(), form.id])" 
