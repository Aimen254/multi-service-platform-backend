<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            ...
            <Link :href="route('boats.dashboard.dealership.create', getSelectedModuleValue())" v-if="checkUserPermissions('add_business')" class="btn btn-sm btn-primary">
        ...
        <div class="card">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <BoatsSearchInput :callType="type" :searchedKeyword="searchedKeyword" :filterFormData="filterForm"/>
                </h3>
            </div>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <delete-section permission="delete_business"
                                                :url="route('boats.dashboard.dealership.destroy', [getSelectedModuleValue(), business.uuid])"
...
export default {
    ...
    data () {
        return {
            ...
            type: 'dealership',
            logoUrl:'',
            urlForFilter: 'boats.dashboard.dealership.index',
            filterForm  : {
    ...
    methods: {
        changeStatus (business) {
            ...
            this.swal.fire({
                ...
                if (result.value) {
                    showWaitDialog()
                    this.$inertia.visit(route('boats.dashboard.dealership.status', [this.getSelectedModuleValue(), business.id]), {
