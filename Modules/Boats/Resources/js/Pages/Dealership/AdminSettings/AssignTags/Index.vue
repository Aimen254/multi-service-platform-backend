                ...
                <div class="mb-5 mb-xl-8">
                    <div class="mt-6 ms-9">
                        <div class="card-title flex-column">
                            <h2 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Dealership Tags</h2>
                        </div>
                    </div>
                    <div class="card-body">
...
export default {
    ...
    methods: {
        assignGlobalTags(id) {
            ...
            this.form.post(route("boats.dashboard.dealership.assign.standard-tags", [this
        ...
        removeProductTags(tags) {
            window.axios.post(route('boats.dashboard.dealership.remove-product-tags', [this.getSelectedModuleValue(), this.business.uuid]) ,
            {
        ...
        fetchSuggestions() {
             window.axios.get(route('boats.dashboard.dealership.business-level-three-tags', [this.getSelectedModuleValue(), this.business.uuid]) ,
            {
                params: {
