        ...
        <form class="mb-4" v-if="form" @submit.prevent="submit">
            <div class="card mb-5">
                <div class="card-header">
                    <div class="card-title fs-3 fw-bold"> {{ plan ? 'Edit Plan' : 'Create Plan' }}</div>
                </div>
            ...
            <div class="card mb-5">
                ...
                <div class="card-body py-3 pt-10">
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column" style="margin-right:550px;">
                                ...
                                <td class="text-end">
                                    <Input id="price" type="number" class="text-end"
                                        :class="{ 'is-invalid border border-danger': form.errors['permissions.total_businesses.value'] }"
                                        :disabled="!permissions.total_businesses.status"
                                        v-model="permissions.total_businesses.value"
                                        style="width:40%; display: -webkit-inline-box;" />
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <Input id="price" type="number" class="text-end"
                                        :class="{ 'is-invalid border border-danger': form.errors['permissions.featured_businesses.value'] }"
                                        :disabled="!permissions.featured_businesses.status"
                                        v-model="permissions.featured_businesses.value"
                                        style="width:40%; display: -webkit-inline-box;" />
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <Input id="price" type="number" class="text-end"
                                        :class="{ 'is-invalid border border-danger': form.errors['permissions.total_products.value'] }"
                                        :disabled="!permissions.total_products.status"
                                        v-model="permissions.total_products.value"
                                        style="width:40%; display: -webkit-inline-box;" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column" style="margin-right:550px;">
                                            <a href="#" class="text-dark fw-bold text-hover-primary fs-6">Subscription
                                                Type</a>
                                            <!-- <span class="text-muted fw-semibold text-muted d-block fs-7">xyz</span> -->
                                        </div>
                                    </div>
                                ...
                                <td class="text-end">
                                    ...
                                    <select class="form-select form-select-solid"
                                        :class="{ 'is-invalid border border-danger': form.errors['permissions.type.value'] }"
                                        v-model="permissions.type.value">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column" style="margin-right:550px;">
                                            <a href="#" class="text-dark fw-bold text-hover-primary fs-6">Featured
                                                Notices</a>
                                            <!-- <span class="text-muted fw-semibold text-muted d-block fs-7">xyz</span> -->
                                        </div>
                                    </div>
                    ...
                    <div class="text-end mt-5">
                        <Button type="submit" :classes="'btn btn-lg btn-primary'" :class="{ 'opacity-25': form.processing }"
                            :disabled="form.processing" ref="submitButton">
                            <span class="indicator-label" v-if="!form.processing">
                                Save plan
                                <span class="svg-icon svg-icon-3 ms-2 me-0"><svg fill="none" viewBox="0 0 24 24" height="24"
...
export default {
    ...
    methods: {
        async submit() {
            ...
            if (this.form.id) {
                this.form.put(route('notices.dashboard.subscription.plan.update', [this.getSelectedModuleValue(), this.form.id]), {
                    errorBag: null,
                ...
                this.form.post(route('notices.dashboard.subscription.plan.store', [this.getSelectedModuleValue()]), {
                    errorBag: null,
                    preserveScroll: false,
                    onSuccess: () => {
                        this.processing = false
    ...
    mounted() {
        this.form = useForm({
            ...
            interval: this.plan ? this.plan.price.recurring.interval : '',
