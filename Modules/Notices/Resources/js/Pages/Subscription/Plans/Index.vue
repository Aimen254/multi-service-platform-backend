    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <Link :href="route('notices.dashboard.subscription.plan.create', [getSelectedModuleValue()])"
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <edit-section permission="edit_subscription_plan"
                                                :url="route('notices.dashboard.subscription.plan.edit', [getSelectedModuleValue(), subscription.product.id])"
                                                :iconType="'link'" />
                                            <delete-section permission="delete_subscription_plan"
                                                :url="route('notices.dashboard.subscription.plan.destroy', [getSelectedModuleValue(), subscription.product.id])" 
