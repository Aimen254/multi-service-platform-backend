<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Create Notice`" :path="`Notices - Notices`" />
        </template>
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="row mb-4 fv-plugins-icon-container">
                                ...
                                <div class="col-lg-12 py-2">
                                    <Label for="description" class="required" value="Description" />
...
export default {
    ...
    methods: {
        submit() {
            ...
            this.form.post(route('notices.dashboard.organization.notices.store', [this.getSelectedModuleValue(), this.getSelectedBusinessValue()]), {
                errorBag: "product",
                preserveScroll: true,
                onError: (errors) => {
    ...
    mounted() {
        this.form = this.$inertia.form({
            ...
            is_featured: false,
            description: '',
            level_two_tag: this.levelTwoTagOptions.length == 1 ? this.levelTwoTagOptions[0].id : null,
