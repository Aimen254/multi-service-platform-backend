<template>
    <Head title="Notice Reviews" />
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Notice reviews`" :path="`Notice -${product?.name}`" />
        </template>
                ...
                <div class="card card-flush py-4">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <h3 class="card-title align-items-start flex-column">
                                <NoticesSearchInputVue :module="module" :callType="type" :searchedKeyword="searchedKeyword"
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <delete-section permission="delete_reviews"
                                                        :url="route('notices.dashboard.notices.reviews.destroy', [getSelectedModuleValue(), product.uuid, review.id])" 
