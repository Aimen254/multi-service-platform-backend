...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            this.loading = true;
            if (this.type == 'post') {
                window.axios.post(route('notices.dashboard.organization.organizationsholidays.store', [this.getSelectedModuleValue(), this.business.uuid]), this.form)
                    .then((response) => {
                        this.reset();
                ...
                this.form.date = this.days;
                window.axios.put(route('notices.dashboard.organization.organizationsholidays.update', [this.getSelectedModuleValue(), this.form.id, this.business.uuid]), this.form)
                    .then((response) => {
                        this.reset();
                        this.businessHolidays = response.data.businessHolidays;
                        this.$emit('childToParentHolidayModel', this.businessHolidays);
