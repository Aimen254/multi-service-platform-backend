<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Organization`" :path="`Organization`"></Breadcrumbs>
        </template>
            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="border border-1 rounded-3">
                                ...
                                <div class="menu menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-280px"
                                    ...
                                    <div class="menu-item px-5">
                                        ...
                                        ]" @click="getSchedule(business.id, Schedule.id, Schedule.name)">
                                            {{ Schedule.name }}
                                        </a>
                                    </div>
                                    <div class="menu-item px-5">
                        ...
                        <div class="col-md-8 ">
                            <div
                                :class="[(businessHolidays || businessSchedule) ? 'border border border-1 rounded-3' : '']">
                                <div v-if="businessSchedule" class=" row metronik-table-head-bg-color p-3 gx-0">
                                    ...
                                    <div class="col-md-4 d-flex justify-content-end">
                                        <button @click="
                                            openScheduleModal(businessSchedule, businessSchedule.name, 'post')"
                                ...
                                <div v-if="businessSchedule.scheduletimes" class="table-responsive bg-white ">
                                    <table class="table align-middle gs-0 gy-4 table-row-dashed">
                                        ...
                                        <tbody v-if="businessSchedule.scheduletimes &&
                                            ...
                                            ">
                                            <tr v-for="(schedule, index) in businessSchedule.scheduletimes" :key="index"
                                                class="ps-4">
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <span href="#"
                                                                class="text-dark fw-bolder text-hover-primary mb-1 fs-6 ms-4">
                                                ...
                                                <td>
                                                    <div class="text-end px-5">
                                                        <div @click="openHolidayModal(holiday, 'put')" v-if="checkUserPermissions(
                                                            ...
                                                            "
                                                            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 ml-3">
                                                            <span class="svg-icon svg-icon-3">
...
export default {
    ...
    methods: {
            ...
            this.swal
                ...
                .then((result) => {
                    if (result.value) {
                        window.axios
                            .delete(
                                route("notices.dashboard.organization.organizationSchedules.destroy", [
            ...
            this.swal
                ...
                .then((result) => {
                    if (result.value) {
                        window.axios
                            .delete(
                                route("notices.dashboard.organization.organizationsholidays.destroy", [
                                    this.getSelectedModuleValue(),
                                    id,
                                    this.business.uuid,
                                ])
        ...
        updateBusinessSchedule(businessUuid, scheduleId) {
            window.axios
                .post(
                    route("notices.dashboard.organization.organizationSchedule.status", [
                        this.getSelectedModuleValue(),
                        businessUuid,
                        scheduleId,
                        businessUuid,
        ...
        getSchedule(businessId, ScheduleId, ScheduleName) {
            ...
            window.axios
                .get(
                    route("notices.dashboard.organization.organizationSchedules.schedule", [
                        this.getSelectedModuleValue(),
                        businessId,
                        ScheduleId,
                    ])
        ...
        getHolidays(businessId) {
            window.axios
                .get(
                    route("notices.dashboard.organization.organizationsholidays.show", [
                        this.getSelectedModuleValue(),
                        businessId,
                        businessId,
                    ])
