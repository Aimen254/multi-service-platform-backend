<template>
    ...
    <BreezeAuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Business Tags`" :path="`Organizations - Admin Settings`" />
        </template>
...
export default {
    ...
    methods: {
        assignGlobalTags(id) {
            ...
            this.$inertia.visit(route("notices.dashboard.organization.assign.standard-tags", [this
        ...
        removeProductTags(tags) {
            window.axios.post(route('notices.dashboard.organization.remove-product-tags', [this.getSelectedModuleValue(), this.business.uuid]),
                {
        ...
        fetchSuggestions() {
            window.axios.get(route('notices.dashboard.organization.business-level-three-tags', [this.getSelectedModuleValue(), this.business.uuid]),
                {
                    params: {
