        ...
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="">
                        ...
                        <div class="fv-row mb-4">
                            <div class="image-input image-input-outline image-input-empty" data-kt-image-input="true">
                                ...
                                <input id="logo" type="file" class="d-none" :accept="accept"
                                    @change="onFileChange($event, 'logo')" />
                                <RemoveImageButton v-if="url" :title="'Remove Logo'"
                                    @click="removeImage(business.logo.id, 'logo')" />
                            </div>
                            <p class="fs-9 text-muted pt-2">Image must be {{ mediaLogoSizes.width }} x
                                {{ mediaLogoSizes.height }}</p>
                        </div>
                    ...
                    <div class="pt-12">
                        ...
                        <div class="fv-row mb-4">
                            <div class="image-input image-input-outline image-input-empty" data-kt-image-input="true">
                                ...
                                <input id="thumbnail" type="file" class="d-none" :accept="accept"
                            ...
                            <p class="fs-9 text-muted pt-2">Image must be {{ mediaThumbnailSizes.width }} x
                                {{ mediaThumbnailSizes.height }}</p>
                        </div>
                ...
                <div class="col-md-10">
                    <h4>Banner</h4>
                    <div class="fv-row mb-4">
                        <div class="image-input image-input-outline image-input-empty w-100" data-kt-image-input="true">
                            <div class="image-input-wrapper w-100 h-350px"
                            ...
                            <input id="banner" type="file" class="d-none" :accept="accept"
                        ...
                        <p class="fs-9 text-muted pt-2">Image must be {{ mediaBannerSizes.width }} x
                            {{ mediaBannerSizes.height }}</p>
                    </div>
            ...
            <div class="row mt-2">
                <div class="col-lg-12">
                    ...
                    <p class="fs-9 text-muted pt-4">Image must be {{ mediaBannerSizes.width }} x {{ mediaBannerSizes.height
                    }}
                    </p>
                </div>
            </div>
