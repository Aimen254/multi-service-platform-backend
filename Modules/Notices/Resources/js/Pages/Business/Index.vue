<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`All Organizations`" :path="`Organizations`" />
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <Link :href="route('notices.dashboard.organizations.create', getSelectedModuleValue())"
        ...
        <div class="card">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <NoticesSearchInput :callType="type" :searchedKeyword="searchedKeyword" :filterFormData="filterForm" />
                </h3>
            </div>
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-4">
                        <thead>
                            <tr class="fw-bolder border-0 text-muted bg-light">
                                ...
                                <th class="min-w-120px">Organization Owner</th>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <delete-section permission="delete_business"
                                                :url="route('notices.dashboard.organizations.destroy', [getSelectedModuleValue(), business.uuid])" 
...
export default {
    ...
    data() {
        return {
            ...
            type: 'business',
            logoUrl: '',
            urlForFilter: 'notices.dashboard.organizations.index',
            filterForm: {
    ...
    methods: {
        changeStatus(business) {
            ...
            this.swal.fire({
                ...
                if (result.value) {
                    showWaitDialog()
                    this.$inertia.visit(route('notices.dashboard.organization.status', [this.getSelectedModuleValue(), business.id]), {
