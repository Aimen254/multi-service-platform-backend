...
class NoticeMediaController extends Controller
{
    /**
    ...
    public function index($moduleId, $uuid)
    {
        ...
        return Inertia::render('Notices::Notices/Settings/NoticeMedia', [
            'product' => $product,
    ...
    public function update(Request $request, $moduleId, $uuid, $id = null)
    {
        ...
        try {
            ...
            flash('Notice main image updated successfully.', 'success');
