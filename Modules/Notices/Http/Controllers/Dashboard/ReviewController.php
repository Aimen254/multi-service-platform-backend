...
class ReviewController extends Controller
{
    ...
    public function index($moduleId, $businessUuid)
    {
        ...
        return Inertia::render('Notices::Business/Review/Index', [
            'business' => $business,
            'reviews' => $reviews,
            'title' => 'Reviews',
    ...
    public function destroy($moduleId, $businessId, $id,Request $request)
    {
        try {
            ...
            if ($currentCount > 1) {
                ...
                return Redirect::route('notices.dashboard.organization.reviews.index', [$moduleId,$businessId, 'page' => $previousPage]);
            }
