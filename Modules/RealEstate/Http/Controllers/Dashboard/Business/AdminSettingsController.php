...
class AdminSettingsController extends Controller
{
     ...
     * @return Renderable
     */
    public function index($module_id, $businessUuid)
    {
        ...
        return Inertia::render('RealEstate::Business/AdminSettings/AssignTags/Index', [
            'business' => $business,
    ...
    public function chatAdminSettings($module_id, $businessUuid)
    {
        ...
        return Inertia::render('RealEstate::Business/AdminSettings/ChatSetting/Index', [
            'business' => $business,
        ]);
    }
    ...
    public function assignTags($module_id, $businessUuid)
    {
        try {
            DB::beginTransaction();
            $business = Business::where('uuid', $businessUuid)->firstOrFail();
            ...
            // AssignTagsToStore::dispatch($business, $tags, $business->standardTags, $module);
