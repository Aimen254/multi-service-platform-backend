...
class ReviewController extends Controller
{
    ...
    public function index($moduleId, $businessUuid)
    {
        ...
        $business = Business::findOrFail(getBusinessDetails($businessUuid)->id);
        ...
        return Inertia::render('RealEstate::Business/Review/Index', [
            'business' => $business,
            'reviews' => $reviews,
            'title' => 'Reviews',
    ...
    public function destroy($moduleId, $id,$businessId,Request $request)
    {
        try {
            ...
            if ($currentCount > 1) {
                ...
                return Redirect::route('real-estate.dashboard.broker.reviews.index', [$moduleId,$businessId, 'page' => $previousPage]);
            }
