<template>
    ...
    <BreezeAuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Business Tags`" :path="`Brokers - Admin Settings`" />
        </template>
...
export default {
    ...
    methods: {
        assignGlobalTags(id) {
            ...
            window.axios.post(route("real-estate.dashboard.broker.assign.standard-tags", [this
        ...
        removeProductTags(tags) {
            window.axios.post(route('real-estate.dashboard.broker.remove-product-tags', [this.getSelectedModuleValue(), this.business.uuid]),
                {
        ...
        fetchSuggestions() {
            window.axios.get(route('real-estate.dashboard.broker.business-level-three-tags', [this.getSelectedModuleValue(), this.business.uuid]),
                {
                    params: {
