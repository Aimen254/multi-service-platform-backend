<template>
    <Head title="Edit Broker" />
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Edit Broker`" :path="`Broker`" :subTitle="`Edit Broker`">
            </Breadcrumbs>
        </template>
                ...
                <form v-if="form" @submit.prevent="submit" ref="form">
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-12 fv-row mb-2 fv-plugins-icon-container" v-if="is_admin">
                            <Label for="Dealership Owner" class="required" value="Broker Owner" />
...
export default {
    ...
    methods: {
        submit() {
            this.form.put(route('real-estate.dashboard.brokers.update', [this.getSelectedModuleValue(), this.business.uuid]), {
                errorBag: 'business',
