<template>
    ...
    <AuthenticatedLayout>
        ...
        <template #breadcrumbs>
            <Breadcrumbs :title="`Reviews`" :path="`Brokers`" />
        </template>
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">
                        <RealEstateSearchInput :business="business" :callType="type" :searchedKeyword="searchedKeyword" />
                    </span>
                </h3>
            </div>
            <!--end::Header-->
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <delete-section permission="delete_reviews"
                                                :url="route('real-estate.dashboard.broker.reviews.destroy', [getSelectedModuleValue(), review.id, business.id])" 
        ...
        changeStatus(id) {
            this.swal.fire({
                ...
                if (result.value) {
                    ...
                    this.$inertia.visit(route('real-estate.dashboard.broker.review.status', [this.getSelectedModuleValue(), id, this.business.id]), {
