<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Create Property`" :path="`Real Estate - Properties`" />
        </template>
...
export default {
    props: ['level', 'parentCategoires', 'mediaSizes', 'levelTwoTags', 'agents'],
    components: {
        Head,
        AuthenticatedLayout,
        Input,
    ...
    methods: {
        submit() {
            ...
            this.form.post(route('real-estate.dashboard.broker.properties.store', [this.getSelectedModuleValue(), this.getSelectedBusinessValue()]), {
                errorBag: "product",
                preserveScroll: true,
                onError: (errors) => {
