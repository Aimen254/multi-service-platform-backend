<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Assign Tags`" :path="`Properties - ${limit(product?.name)}`" />
        </template>
                    ...
                    <div class="card card-flush py-4">
                        <div class="card-body py-3 row">
                            ...
                            <div class="fv-row mb-4 fv-plugins-icon-container">
                                ...
                                <TagComponent placeholder="Brand tags" :uuid="product.uuid" :assignedTags="allproductBrandTags" type="brand"  :tooltipContent="'Brand Tags Information.'"/>
                                <error :message="form.errors.tags" />
                            </div>
                            <div class="fv-row mb-4 fv-plugins-icon-container">
...
export default {
    ...
    methods: {
        submit () {
            ...
            this.form.get(route("real-estate.dashboard.properties.tags.assign", [this
