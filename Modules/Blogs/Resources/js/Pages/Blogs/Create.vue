<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Create Blog`" :path="`Blogs - Blog`" />
        </template>
        <div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-4 fv-plugins-icon-container">
                                    <div class="col-lg-6 py-2">
                                        ...
                                        <Input id="name" type="text" v-model="form.name"
                                            ...
                                            autocomplete="name" placeholder="Enter blog title" />
                                ...
                                <div class="row" style="margin-top: 8%;">
                                    <div class="col-lg-6 py-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value=""
                                                id="CheckDefault" :checked="form?.is_featured"
                                    ...
                                    <div class="col-lg-6 py-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value=""
                                                id="flexCheckDefault" :checked="form?.is_commentable"
...
export default {
    ...
    mounted() {
        ...
        this.url = this.blog ? this.blog.image : null;
    ...
    methods: {
        submit() {
            ...
            this.form.post(route('blogs.dashboard.blogs.store', this.getSelectedModuleValue()), {
                    errorBag: 'blog',
                    preserveScroll: true,
                    onError: () => {
