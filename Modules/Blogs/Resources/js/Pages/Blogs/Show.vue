<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`View Blog`" :path="`Blogs - ${limit(product?.name, 36)}`" />
        </template>
        <div>
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-5">
                            <div class="card-title">
                                <h2 class="text-center">Blog Detail</h2>
                            </div>
                        </div>
                        <!--end::Header-->
                ...
                <div class="card">
                    <div class="card-header border-0 pt-5">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <h3 class="card-title align-items-start flex-column">
                                <BlogSearchInput :module="module" :callType="type" :searchedKeyword="searchedKeyword"
...
import CommentModal from '../Blogs/Comments/Modal.vue';
