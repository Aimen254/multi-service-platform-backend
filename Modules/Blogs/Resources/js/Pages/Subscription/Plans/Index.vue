    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <Link :href="route('blogs.dashboard.subscription.plan.create', [getSelectedModuleValue()])" v-if="checkUserPermissions('add_subscription_plan')" class="btn btn-sm btn-primary">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <edit-section
                                                ...
                                                :url="route('blogs.dashboard.subscription.plan.edit', [getSelectedModuleValue(),subscription.product.id])"
                                                :iconType="'link'"/>
                                            <delete-section
                                                permission="delete_subscription_plan"
                                                :url="route('blogs.dashboard.subscription.plan.destroy', [getSelectedModuleValue(), subscription.product.id])" 
