<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Blogs`" :path="`HeadLines`" />
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <Link v-if="checkUserPermissions('add_headlines')" @click="removeHedinLineType()"
                    :href="route('blogs.dashboard.headlines.create', this.getSelectedModuleValue())"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <delete-section iconType="link" permission="delete_headlines"
                                            ...
                                            :url="route('blogs.dashboard.headlines.destroy', [getSelectedModuleValue(), item.headline?.id])" 
