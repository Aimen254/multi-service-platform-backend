<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Create HeadLine`" :path="`Blogs - HeadLine`" />
        </template>
        <div>
            <div v-if="filterForm">
                <!--begin::Layout-->
            ...
            <div :class="widgetClasses" class="card">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">
                            <BlogSearchInput :callType="'headLineFilter'" :filterFormData="filterForm"
                ...
                <div v-if="blogs">
                    ...
                    <!--begin::Body-->
                    <pagination :meta="blogs" :keyword="searchedKeyword" :callType="'headLineFilter'"
...
export default {
    props: ['levelTwoTags', 'blogList', 'type', 'tag', 'searchedKeyword'],
    components: {
        Head,
        AuthenticatedLayout,
        Breadcrumbs,
    ...
    methods: {
        featchProducts() {
            ...
            this.$inertia.visit(route('blogs.dashboard.headlines.create', this.getSelectedModuleValue()), {
                data: {
                    type: localStorage.getItem('headLineType') ? localStorage.getItem('headLineType') : 'Primary',
        ...
        makeHeadLine(product) {
            this.swal.fire({
                ...
                if (result.value) {
                    showWaitDialog()
                    window.axios.post(route('blogs.dashboard.headlines.store', this.getSelectedModuleValue()), {
