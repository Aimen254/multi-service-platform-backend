<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :path="`Tasks - ${limit(product?.name, 36)}`" :title="`View Task`"/>
        </template>
        <div>
            <div class="row gx-5 gx-xl-10">
                <div class="col-xl-12 mb-5 mb-xl-10">
                    ...
                    <div class="card card-flush h-xl-100">
                        <!--begin::Header-->
                        <div class="card-header pt-5 justify-content-between">
                            <div class="card-title">
                                <h2 class="text-center">Task Detail</h2>
                            </div>
                            <div>
                                    <span
                                        :class="{ 'badge badge-light-success': product?.status == 'active', 'badge badge-light-danger': product?.status == 'inactive' || product?.status == 'tags_error' }"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 d-flex mt-3">
                                    <div class="image-input image-input-empty pb-3">
                                        <div :style="{ 'background-image': 'url(' + getImage(product.main_image ? product.main_image.path : null, true, 'product', product.main_image ? product.main_image.is_external : 0) + ')' }"
                ...
                <div class="card">
                    <div class="card-header border-0 pt-5">
                        <h4>Comments <span v-if="product?.is_commentable === 0"
                                           style="font-size: 10px; color: #6c757d;">&#40;Comments are turned off&#41;</span>
                        </h4>
                        <h3 class="card-title align-items-start flex-column">
                            <h3 class="card-title align-items-start flex-column">
                                <TaskerSearchInput :callType="type" :module="module" :product="product.uuid"
                                        ...
                                        <td class="px-4">
                                            <div class="d-flex align-items-center">
                                                <div class="image-input image-input-empty">
                                                    <div :style="{ 'background-image': 'url(' + getImage(comment.user.avatar) + ')' }"
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <button class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                                        ...
                                                        data-bs-original-title="view" data-bs-placement="bottom"
                                                        data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                        permission="view_comment" @click="openModal(comment)"><i
                                                    class="fas fa-eye"></i></button>
                                                <delete-section :url="route('taskers.dashboard.taskers.comments.destroy', [getSelectedModuleValue(), product.uuid, comment.id])"
...
import CommentModal from '../Taskers/Comments/Modal.vue';
