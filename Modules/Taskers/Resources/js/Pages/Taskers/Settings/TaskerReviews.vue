<template>
    <Head title="Tasker Reviews" />
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Tasker reviews`" :path="`Tasker -${product?.name}`" />
        </template>
        <div class="d-flex flex-column flex-lg-row">
            <TaskerSidebar :tasker="product" style="width: 25%!important;" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    :url="route('taskers.dashboard.taskers.reviews.destroy',[getSelectedModuleValue(),product.uuid, review.id])" 
