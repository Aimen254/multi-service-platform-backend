...
namespace Modules\Events\Http\Controllers\Dashboard;
...
use Modules\Events\Http\Requests\TagHierarchyRequest;
...
class HierarchiesController extends Controller
{
    ...
    public function index(Request $request, $module_id, $level)
    {
        ...
        return Inertia::render('Events::TagHierarchy/Index', [
