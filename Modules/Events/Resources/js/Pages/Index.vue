<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Events`" :path="`Events`"></Breadcrumbs>
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <div class="me-4">
                    ...
                    <Filter :filterData="filterForm" :callType="type" :business="events" :url="urlForFilter"
                        :maxPrice="maxPrice" :minPrice="minPrice" :newKeyword="searchedKeyword">
                        <div class="mb-5">
                ...
                <Link v-if="checkUserPermissions('add_products')"
                    :href="route('events.dashboard.events.create', this.getSelectedModuleValue())"
        ...
        <div :class="widgetClasses" class="card">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">
                        <EventSearch :callType="type" :searchedKeyword="searchedKeyword" />
                    </span>
                </h3>
            </div>
            <!--end::Header-->
                    ...
                    <table class="table align-middle gs-0 gy-4 table-row-dashed">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="ps-4 min-w-150px rounded-start">Ticket Price</th>
                        ...
                        <tbody v-if="events?.data?.length > 0">
                            ...
                            <template v-for="item in events.data" :key="item.id">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="text-muted tex-center fw-bold text-muted d-block text-capitalize fs-7">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <view-section permission="view_products"
                                                :url="route('events.dashboard.events.show', [getSelectedModuleValue(), item.uuid])" />

                                            <edit-section iconType="link" permission="edit_products"
                                                :url="route('events.dashboard.events.edit', [getSelectedModuleValue(), item.uuid])" />

                                            <delete-section permission="delete_products"
                                                :url="route('events.dashboard.events.destroy', [getSelectedModuleValue(), item.uuid])" 
                                                :currentPage="events.current_page" :currentCount="events.data.length"/>
                                        </div>
            ...
            <!--begin::Body-->
            <pagination :meta="events" :keyword="searchedKeyword" />
        </div>
...
export default {
    ...
    props: ["eventList", "searchedKeyword", "orderBy", "status", "tag", "barValueMin", "barValueMax", 'maxPrice', 'minPrice'],
    ...
    data() {
        return {
            ...
            type: "events",
            module: 'events',
            urlForFilter: 'events.dashboard.events.index',
            filterForm: {
        ...
        changeStatus(uuid) {
            this.swal.fire({
                ...
                if (result.value) {
                    ...
                    this.$inertia.visit(route('events.dashboard.events.status', [this.getSelectedModuleValue(), uuid]), {
        ...
        getTags() {
            ...
            setTimeout(() => {
                $(".select").select2({
                    ...
                    // ajax request
                    ajax: {
                        url: route("events.dashboard.search.events.tags", parameters),
                        dataType: "json",
                        delay: 250,
