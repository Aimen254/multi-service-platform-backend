<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Edit Event`" :path="`Events - ${limit(form?.name, 36)}`" />
        </template>
        <div class="d-flex flex-column flex-lg-row">
            <EventsSidbarManu :events="event" :width="'w-lg-820px'" />
                            ...
                            <div class="row mt-8">
                                <div class="col-lg-12 py-2">
                                    ...
                                    <Input id="name" type="text"
                                        ...
                                        autofocus autocomplete="name" placeholder="Enter event title" />
                                ...
                                <div class="col-lg-6 py-2">
                                    <Label for="price" class="required" value="Date" />
                                ...
                                <div class="col-lg-12 py-2">
                                    ...
                                    <QuillEditor theme="snow" v-model:content="form.description" contentType="html"
                                        placeholder='Compose event description...' />
                            ...
                            <div class="row" style="margin-top: 12%;">
                                ...
                                <div class="col-lg-6 py-3">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefaultFor">
                                            Commentable
                                        </label>
                                    </div>
                                </div>
...
export default {
    props: ['event', 'levelTwoTags', 'productLevelTwoTag', 'mediaSizes'],
    ...
    methods: {
        submit() {
            this.form.put(route('events.dashboard.events.update', [this.getSelectedModuleValue(), this.event.uuid]), {
                errorBag: "event",
                preserveScroll: true,
            });
        },
        getLevelThreeTags(tag, level) {
            ...
            setTimeout(() => {
                ...
                // selected value
                window.axios.get(route('events.dashboard.events.tags', [this.getSelectedModuleValue(), tag, level]), {
                    params: {
                        event: this.event.id
                    }
                })
    ...
    mounted() {
        this.form = this.$inertia.form({
            ...
            is_featured: this.event.is_featured ? true : false,
            is_commentable: this?.event?.is_commentable ? true : false,
            level_four_tags: null,
            event_location: this.event.events.event_location ?? null,
            event_date: this.event.events.event_date ?? null,
            price: this.event.price ?? null,
            max_price: this.event.max_price?? null,
            performer: this.event.events.performer ?? null,
            away_team: this.event.events.away_team ?? null,
            ticket_url: this.event.events.event_ticket ?? null,
        });
