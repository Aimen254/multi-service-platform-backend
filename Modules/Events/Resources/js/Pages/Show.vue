<template>
    <Head title="Events Detail" />
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`View Events`" :path="`Events - ${limit(product?.name, 36)}`" />
        </template>
        <div>
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-5">
                            <div class="card-title">
                                <h2 class="text-center">Events Detail</h2>
                            </div>
                        </div>
                        <!--end::Header-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 pb-3 d-flex align-items-center">
                                    <div class="image-input-wrapper">
                                        <img :src="getImage(product?.user?.avatar, true, 'avatar')" alt="author image" style="height: 37px !important;width: 37px !important;border: 1px solid rgb(156 163 175);border-radius: 50%;" />
                                        </div>
                                    <div>
                                        <span class="fw-bold" style="margin-left: 10px;">{{ product?.user?.first_name + ' ' + product?.user?.last_name }}</span>
                                    </div>
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    :url="route('blogs.dashboard.blogs.comments.destroy',[getSelectedModuleValue(),product.uuid, comment.id])" />
                                                </div>
                                            </td>
                                        </tr>
                                    </template>
