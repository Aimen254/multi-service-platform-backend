<template>
    <Head title="Employer Tags" />
    <BreezeAuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Employer Tags`" :path="`Employers - Admin Settings`" />
        </template>
                ...
                <div class="mb-5 mb-xl-8">
                    <div class="mt-6 ms-9">
                        <div class="card-title flex-column">
                            <h2 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Employer tags</h2>
                        </div>
                    </div>
                    <div class="card-body">
...
export default {
    ...
    methods: {
        assignGlobalTags(id) {
            ...
            this.$inertia.visit(route("employment.dashboard.employers.assign.standard-tags", [this
        ...
        removeProductTags(tags) {
            window.axios.post(route('employment.dashboard.employers.remove-product-tags', [this.getSelectedModuleValue(), this.business.uuid]) , 
            {
        ...
        fetchSuggestions() {
             window.axios.get(route('employment.dashboard.employers.business-level-three-tags', [this.getSelectedModuleValue(), this.business.uuid]) , 
            {
                params: {
