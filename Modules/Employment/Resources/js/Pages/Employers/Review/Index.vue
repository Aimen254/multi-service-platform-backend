<template>
    ...
    <AuthenticatedLayout>
        ...
        <template #breadcrumbs>
            <Breadcrumbs :title="`Reviews`" :path="`Employers`" />
        </template>
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">
                        <EmploymentSearchInput :business="business" :callType="type" :searchedKeyword="searchedKeyword"/>
                    </span>
                </h3>
            </div>
            <!--end::Header-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            :url="route('employment.dashboard.employers.reviews.destroy', [getSelectedModuleValue(), review.id, business.id])" 
        ...
        changeStatus(id) {
            this.swal.fire({
                ...
                if (result.value) {
                    ...
                    this.$inertia.visit(route('employment.dashboard.employers.review.status', [this.getSelectedModuleValue(), id, this.business.id]), {
