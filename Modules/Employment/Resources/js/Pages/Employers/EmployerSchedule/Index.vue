<template>
  <Head title="Employer Schedule" />
  <AuthenticatedLayout>
    <template #breadcrumbs>
      <Breadcrumbs :title="`Employer Schedule`" :path="`Employers`"></Breadcrumbs>
    </template>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-4 bg-white px-0 border border-1 rounded-3">
              ...
              <div class="menu menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-280px"
                  v-if="
                ...
                <div class="menu-item px-5">
                  <a
                    v-for="(Schedule, index) in business.businessschedules"
                    :key="index"
                    :class="[
            ...
            <div class="col-md-8 ">
              <div :class="[
                ...
                <div
                  v-if="businessSchedule"
                  class=" row metronik-table-head-bg-color p-3 gx-0"
                >
                  <div class="col-md-4 ">
                  ...
                  <div class="col-md-4 d-flex justify-content-center">
                    ...
                    <Toggle
                      :status="booleanStatusValue(businessSchedule.status)"
                      class=""
                      @click="
                  ...
                  <div class="col-md-4 d-flex justify-content-end">
                    <button
                      ...
                      "
                      v-if="checkUserPermissions('add_business_schedule_time')"
                ...
                <div
                  v-if="businessSchedule.scheduletimes"
                ...
                >
                  <table class="table align-middle gs-0 gy-4 table-row-dashed">
                    ...
                    <tbody
                      v-if="
                        businessSchedule.scheduletimes &&
                    ...
                    >
                      <tr
                        v-for="(
                          schedule, index
                        ) in businessSchedule.scheduletimes"
                        :key="index"
                        class="ps-4"
                      >
                        <td>
                ...
                >
                  ...
                  <div class="col-md-6 d-flex justify-content-end">
                    <button
                      @click="openHolidayModal(businessHolidays, 'post')"
                      v-if="checkUserPermissions('add_business_schedule_time')"
                      class="btn btn-primary btn-sm"
                    >
                      Add
                ...
                <div v-if="businessHolidays" class="table-responsive bg-white">
                  <table class="table align-middle gs-0 gy-4 table-row-dashed">
                    ...
                    <tbody
                      v-if="businessHolidays && businessHolidays.length > 0"
                    >
                      <tr
                        v-for="(holiday, index) in businessHolidays"
                        :key="index"
                        class="ps-4"
                      >
                        <td>
                        ...
                        <td>
                          <div class="text-end px-5">
                            <div
                              @click="openHolidayModal(holiday, 'put')"
                              v-if="
  ...
  <EmployerScheduleModal
    :business="business"
    v-on:childToParent="onChildClick"
  ></EmployerScheduleModal>
  <EmployerHolidayModal
    :business="business"
    v-on:childToParentHolidayModel="onChildHolidayModel"
  ></EmployerHolidayModal>
</template>
...
import EmployerScheduleModal from "./EmployerScheduleModal.vue"
import EmployerHolidayModal from "./EmployerHolidayModal.vue"
...
export default {
  ...
  methods: {
      ...
      this.swal
        ...
        .then((result) => {
          if (result.value) {
            window.axios
              .delete(
                route("employment.dashboard.employers.employerschedule.destroy", [
      ...
      this.swal
        ...
        .then((result) => {
          if (result.value) {
            window.axios
              .delete(
                route("employment.dashboard.employers.employerholidays.destroy", [
                  this.getSelectedModuleValue(),
                  id,
                  this.business.uuid,
                ])
    ...
    updateBusinessSchedule(businessUuid, scheduleId) {
      window.axios
        .post(
          route("employment.dashboard.employers.employerschedule.status", [
            this.getSelectedModuleValue(),
            businessUuid,
            scheduleId,
            businessUuid,
    ...
    getSchedule(businessId, ScheduleId, ScheduleName) {
      ...
      window.axios
        .get(
          route("employment.dashboard.employers.employerschedule.schedule", [
            this.getSelectedModuleValue(),
            businessId,
            ScheduleId,
          ])
    ...
    getHolidays(businessId) {
      window.axios
        .get(
          route("employment.dashboard.employers.employerholidays.show", [
            this.getSelectedModuleValue(),
            businessId,
            businessId,
          ])
