    ...
    props: ['business'],
        ...
        methods: {
            ...
            submit() {
                ...
                this.loading = true;
                if (this.type == 'post') {
                    window.axios.post(route('employment.dashboard.employers.employerholidays.store', [this.getSelectedModuleValue(), this.business.uuid]), this.form)
                        .then((response) => {
                            this.reset();
                    ...
                    this.form.date = this.days;
                    window.axios.put(route('employment.dashboard.employers.employerholidays.update', [this.getSelectedModuleValue(), this.form.id, this.business.uuid]), this.form)
                        .then((response) => {
                            this.reset();
                            this.businessHolidays = response.data.businessHolidays;
                            this.$emit('childToParentHolidayModel', this.businessHolidays);
