<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`All Employers`" :path="`Employers`" />
            ...
            <Link :href="route('employment.dashboard.employers.create', getSelectedModuleValue())" v-if="checkUserPermissions('add_business')" class="btn btn-sm btn-primary">
        ...
        <div class="card">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <EmploymentSearchInput :callType="type" :searchedKeyword="searchedKeyword" :filterFormData="filterForm"/>
                </h3>
            </div>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <delete-section permission="delete_business"
                                                :url="route('employment.dashboard.employers.destroy', [getSelectedModuleValue(), business.uuid])"
...
import EmploymentSearchInput from '../../Components/EmploymentSearchInput.vue'
...
export default {
    ...
    data () {
        return {
            ...
            type: 'business',
            logoUrl:'',
            urlForFilter: 'employment.dashboard.employers.index',
            filterForm  : {
    ...
    methods: {
        changeStatus (business) {
            ...
            this.swal.fire({
                ...
                if (result.value) {
                    showWaitDialog()
                    this.$inertia.visit(route('employment.dashboard.employers.status', [this.getSelectedModuleValue(), business.id]), {
