...
export default {
    ...
    methods: {
        async submit() {
            ...
            if (this.form.id) {
                this.form.put(route('employment.dashboard.subscription.plan.update', [this.getSelectedModuleValue(), this.form.id]), {
                    errorBag: null,
                ...
                this.form.post(route('employment.dashboard.subscription.plan.store', [this.getSelectedModuleValue()]), {
                    errorBag: null,
                    preserveScroll: false,
                    onSuccess: () => {
                        this.processing = false
