        ...
        <template #breadcrumbs>
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <Link v-if="checkUserPermissions('add_products')"
                    :href="route('employment.dashboard.employers.posts.create', [getSelectedModuleValue(), getSelectedBusinessValue()])"
        ...
        <div class="card">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <EmploymentSearchInput :module="module" :callType="type" :searchedKeyword="searchedKeyword" :filterFormData="filterForm" />
                </h3>
            </div>
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-4">
                        <thead>
                            <tr class="fw-bolder border-0 text-muted bg-light">
                                ...
                                <th class="ps-4 min-w-120px rounded-start">Salary</th>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <edit-section iconType="link" permission="edit_products"
                                                :url="route('employment.dashboard.employers.posts.edit', [getSelectedModuleValue(), getSelectedBusinessValue(), product.uuid])" />
                                            <delete-section permission="delete_products"
                                                :url="route('employment.dashboard.employers.posts.destroy', [getSelectedModuleValue(), getSelectedBusinessValue(), product.uuid])" 
...
export default {
    ...
    data() {
        return {
            ...
            type: 'posts',
            urlForFilter: 'employment.dashboard.employers.posts.index',
            filterForm: {
        ...
        changeStatus(uuid) {
            this.swal.fire({
                ...
                if (result.value) {
                    ...
                    this.$inertia.visit(route('employment.dashboard.employers.post.status', [this.getSelectedModuleValue(), this.getSelectedBusinessValue(), uuid]), {
        ...
        getTags() {
            ...
            setTimeout(() => {
                $(".select").select2({
                    ...
                    // ajax request
                    ajax: {
                        url: route("employment.dashboard.employers.search.post.tags", parameters),
                        dataType: "json",
                        delay: 250,
