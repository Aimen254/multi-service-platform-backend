...
class JobCrafterBusinessTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        if (!Business::whereSlug(Str::slug('job-crafters'))->exists()) {
            ...
            $employmentBusiness = Business::create([
                ...
                "name" => "Job Crafters",
                "slug" => Str::slug('Job Crafters'),
                "email" => "jobCarfaters@gmail.com",
