...
namespace Modules\Employment\Http\Controllers\Dashboard\Employer;
...
use Modules\Employment\Http\Requests\SocialLinksRequest;
...
class SocialLinksController extends Controller
{
    ...
    public function index($moduleId, $business_id)
    {
        ...
        return Inertia::render('Employment::Employers/SocialLinks/Index', ['business' => $business]);
    }
