...
namespace Modules\Employment\Http\Controllers\Dashboard\Post;
...
use Modules\Employment\Http\Requests\PostRequest;
...
class PostController extends Controller
{
    ...
    public function index($moduleId,  $businessId)
    {
        ...
        return Inertia::render('Employment::Post/Index', [
    ...
    public function create($moduleId, $businessUuid)
    {
        ...
        $mediaSizes = \config()->get('employment.media.posts');
        $levelTwoTags = null;
        ...
        return Inertia::render('Employment::Post/Create', [
    ...
    public function store(PostRequest $request, $moduleId, $businessUuid)
    {
        try {
            ...
            return \redirect()
                ->route('employment.dashboard.employers.posts.index', [$moduleId, $businessUuid]);
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function edit($moduleId, $busiessId, $uuid)
    {
        try {
            ...
            return Inertia::render('Employment::Post/Edit', [
                'product' => $product,
                'levelTwoTags' => $levelTwoTags,
    ...
    public function destroy($moduleId, $businessUuidd, $uuid,Request $request)
    {
        try {
            ...
            if ($currentCount > 1) {
                ...
                return Redirect::route('obituaries.dashboard.obituaries.index', [$moduleId,$businessUuidd, 'page' => $previousPage]);
            }
        } catch (ModelNotFoundException $e) {
            flash('Unable to find this post.', 'danger');
            return redirect()->back();
