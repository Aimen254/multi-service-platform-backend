...
class ReviewController extends Controller
{
    ...
    public function index($moduleId, $businessUuid)
    {
        ...
        return Inertia::render('Employment::Employers/Review/Index', [
            'business' => $business,
            'reviews' => $reviews,
            'title' => 'Reviews',
    ...
    public function destroy($moduleId, $id,$businessId, Request $request)
    {
        try {
            ...
            if ($currentCount > 1) {
                ...
                return Redirect::route('employment.dashboard.employers.reviews.index', [$moduleId,$businessId, 'page' => $previousPage]);
            }
