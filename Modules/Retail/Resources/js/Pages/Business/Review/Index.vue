                                    ...
                                    <td>
                                        <div class="d-flex">
                                           <Toggle v-if="checkUserPermissions('edit_reviews')"
                                                ...
                                                :url="route('retail.dashboard.business.reviews.destroy', [getSelectedModuleValue(), review.id, business.id])" 
        ...
        changeStatus(id) {
            this.swal.fire({
                ...
                if (result.value) {
                    ...
                    this.$inertia.visit(route('retail.dashboard.business.review.status', [this.getSelectedModuleValue(), id, this.business.id]), {
