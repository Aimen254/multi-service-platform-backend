<template>
  <Head title="Business Schedule" />
  <AuthenticatedLayout>
    <template #breadcrumbs>
      <Breadcrumbs :title="`Business Schedule`" :path="`Businesses`"></Breadcrumbs>
    </template>
              ...
              <div :class="[
                ...
                >
                  ...
                  <div class="col-md-4 d-flex justify-content-center">
                    <label for="checkbox" class="p-2 mt-1">Day</label>
                    <Toggle
                  ...
                  <div class="col-md-4 d-flex justify-content-end">
                    <button
                      ...
                      v-if="checkUserPermissions('add_business_schedule_time')"
                       :disabled="!booleanStatusValue(businessSchedule.status)"
...
export default {
  ...
  methods: {
      ...
      this.swal
        ...
        .then((result) => {
          if (result.value) {
            window.axios
              .delete(
                route("retail.dashboard.business.businessschedules.destroy", [
      ...
      this.swal
        ...
        .then((result) => {
          if (result.value) {
            window.axios
              .delete(
                route("retail.dashboard.business.businessholidays.destroy", [
                  this.getSelectedModuleValue(),
                  id,
                  this.business.uuid,
                ])
    ...
    updateBusinessSchedule(businessUuid, scheduleId) {
      window.axios
        .post(
          route("retail.dashboard.business.businessschedule.status", [
            this.getSelectedModuleValue(),
            businessUuid,
            scheduleId,
            businessUuid,
    ...
    getSchedule(businessId, ScheduleId, ScheduleName) {
      ...
      window.axios
        .get(
          route("retail.dashboard.business.businessschedule.schedule", [
            this.getSelectedModuleValue(),
            businessId,
            ScheduleId,
          ])
    ...
    getHolidays(businessId) {
      window.axios
        .get(
          route("retail.dashboard.business.businessholidays.show", [
            this.getSelectedModuleValue(),
            businessId,
            businessId,
          ])
