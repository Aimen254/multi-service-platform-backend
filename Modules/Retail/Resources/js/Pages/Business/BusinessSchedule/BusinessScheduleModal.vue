    ...
    props: ['business'],
        ...
        methods: {
            ...
            submit() {
                this.loading = true;
                if (this.type == 'post') {
                    window.axios.post(route('retail.dashboard.business.businessschedules.store', [this.getSelectedModuleValue(), this.business.uuid]), this.form)
                        .then((response) => {
                            this.reset();
                    ...
                    window.axios.put(route('retail.dashboard.business.businessschedules.update', [this.getSelectedModuleValue(), this.form.id, this.business.uuid]), this.form)
                        .then((response) => {
                            this.reset();
                            this.businessSchedule = response.data.schedule;
                            this.$emit('childToParent', this.businessSchedule);
