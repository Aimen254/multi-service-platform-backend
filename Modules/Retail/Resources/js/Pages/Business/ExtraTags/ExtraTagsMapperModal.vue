                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-end">
                                <div class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 mb-3"
                                    ...
                                    data-bs-placement="bottom" data-bs-original-title="add more" @click="addTag(index)">
                                    <span class="svg-icon svg-icon-3"><svg fill="none" viewBox="0 0 24 24" height="24"
...
export default {
    ...
    methods: {
        submit() {
            ...
            this.form.put(
                route("retail.dashboard.business.business-tags.update", [this.getSelectedModuleValue(), this.getSelectedBusinessValue(), this.form.tags[0].id]),
                {
        ...
        cloneTag() {
            ...
            this.form.post(route('retail.dashboard.business.business-tags.clone-tag', [this.getSelectedModuleValue(), this.getSelectedBusinessValue, this.tag.id]), {
                preserveScroll: true,
        ...
        addTag(index) {
            ...
            this.filterStandardTags(this.form.tags.length - 1)
        },
    ...
    mounted() {
        this.emitter.on("extra_tag-mapper-modal", (args) => {
            this.tag = args.tag;
