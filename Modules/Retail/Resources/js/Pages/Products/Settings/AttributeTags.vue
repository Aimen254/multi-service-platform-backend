                        ...
                        <div class="card-body py-3 row">
                            <div class="fv-row mb-4 fv-plugins-icon-container" v-for="attribute in attributes" :key="attribute.id">
                                ...
                                <TagComponent @fetchSuggestions="fetchSuggestions" class="text-capitalize" :placeholder="`${attribute.name} tags`" 
                                    ...
                                    type="attribute" :attribute_id="attribute.id"
                                    :autocomplete="attributesTags" :onlyFromAutoComplete="true" :openOnClick="true" :productUuid="product.uuid"/>
...
export default {
    ...
    methods: {
        submit () {
            ...
            this.form.get(route("retail.dashboard.product.attribute-tags.assign", [this
        ...
        fetchSuggestions(event) {
            ...
            window.axios
            .get(
                route("retail.dashboard.product.search.attribute.tags", [
