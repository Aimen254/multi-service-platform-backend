<template>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column"
                                            style="margin-right:550px;">
                                            <a href="#" class="text-dark fw-bold text-hover-primary fs-6">Featured Products</a>
                                            <!-- <span class="text-muted fw-semibold text-muted d-block fs-7">xyz</span> -->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="form-check form-check-sm form-check-custom form-check-solid">
                                        <input class="form-check-input widget-9-check" type="checkbox"
                                            v-model="permissions.delivery.status">
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column"
                                            style="margin-right:550px;">
                                            <a href="#" class="text-dark fw-bold text-hover-primary fs-6">Delivery</a>
                                            <!-- <span class="text-muted fw-semibold text-muted d-block fs-7">xyz</span> -->
                                        </div>
                                    </div>
                                </td>
                                <td class="text-end">
                                    <!-- <Input id="price" type="number" class="text-end" :disabled="!permissions.delivery.status"
                                        v-model="permissions.delivery.value" style="width:40%; display: -webkit-inline-box;"/>
                                    <span class="text-danger d-block fs-7">Enter -1 for unlimited access</span> -->
                                </td>
                            </tr>
                        </tbody>
    ...
    <SubscriptionPlanModa></SubscriptionPlanModa>
</template>
...
import SubscriptionPlanModa from './SubscriptionPlanModa.vue'
...
export default {
    ...
    methods: {
        async submit() {
            ...
            if (this.form.id) {
                this.form.put(route('retail.dashboard.subscription.plan.update', [this.getSelectedModuleValue(), this.form.id]), {
                    errorBag: null,
                ...
                this.form.post(route('retail.dashboard.subscription.plan.store', [this.getSelectedModuleValue()]), {
                    errorBag: null,
                    preserveScroll: false,
                    onSuccess: () => {
                        this.processing = false
    ...
    mounted() {
        ...
        // console.log(this.plan.permissions, 'plan permissions');
        if (this.form.id) {
            ...
            this.permissions.type = {
                'status' : this.plan.permissions[5].status ? true : false,
                'key' : this.plan.permissions[5].key,
                'value' : this.plan.permissions[5].value,
            }
        }
