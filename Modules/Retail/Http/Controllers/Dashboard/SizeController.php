...
class SizeController extends Controller
{
    ...
    public function index($businessUuid)
    {
        ...
        $sizes = Size::where(function ($query) {
            if (request()->keyword) {
        ...
        return Inertia::render('Retail::Products/Sizes/Index', [
    ...
    public function store(Request $request, $moduleId, $businessUuid)
    {
        ...
        $this->business->sizes()->create($request->all());
    ...
    public function update(Request $request, $moduleId, $businessUuid, $id)
    {
        ...
        try {
            ...
            flash('Unable to find this size', 'danger');
            return \redirect()->back();
        } catch (\Exception $e) {
    ...
    public function destroy($moduleId, $businessUuid, $id,Request $request)
    {
        try {
            ...
            if ($currentCount > 1) {
                ...
                return Redirect::route('obituaries.dashboard.obituaries.index', [$moduleId,$businessUuid, 'page' => $previousPage]);
            }
        } catch (ModelNotFoundException $e) {
            flash('Unable to find this size', 'danger');
            return redirect()->back();
