...
namespace Modules\Retail\Http\Controllers\Dashboard\Heirarchies;
...
use Modules\Retail\Http\Requests\TagHierarchyRequest;
...
class HierarchiesController extends Controller
{
    ...
    public function index(Request $request, $module_id, $level)
    {
        ...
        return Inertia::render('Retail::TagHierarchy/Index', [
