                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    :url="route('government.dashboard.post.reviews.destroy',[getSelectedModuleValue(),product.uuid, review.id])" 
...
import GovernmentSearchInput from '../../../Components/GovernmentSearchInput';
...
export default {
    ...
    methods: {
        openModal(review = null) {
            this.emitter.emit("government-post-review-modal", {
                review: review,
            });
        },
    },
