<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Assign Tags`" :path="`Products - ${limit(product?.name)}`" />
        </template>
                    ...
                    <div class="card card-flush py-4">
                        <div class="card-body py-3 row">
                            ...
                            <div class="fv-row mb-4 fv-plugins-icon-container">
                                <Label value="Tags" />
                                <!-- <TagComponent placeholder="Extra Tags" :uuid="product.uuid" :assignedTags="extraTag" :autocomplete="filteredAllTags" :onlyFromAutoComplete="false" :openOnClick="false" :tooltipContent="'Mapped Tags Information.'"/> -->
                            ...
                            <div class="fv-row mb-4 fv-plugins-icon-container">
                                ...
                                <TagComponent placeholder="Brand tags" :uuid="product.uuid" :assignedTags="allproductBrandTags" type="brand" :autocomplete="allBrandTags" :onlyFromAutoComplete="true" openOnClick="true" :tooltipContent="'Brand Tags.'"/>
                                <error :message="form.errors.tags" />
                            </div>
                            <div class="fv-row mb-4 fv-plugins-icon-container">
...
export default {
    ...
    methods: {
        submit () {
            ...
            this.form.get(route("government.dashboard.post.post-tags.assign", [this
