<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`All Departments`" :path="`Departments`" />
            ...
            <Link :href="route('government.dashboard.departments.create', getSelectedModuleValue())" v-if="checkUserPermissions('add_business')" class="btn btn-sm btn-primary">
        ...
        <div class="card">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <GovernmentSearchInput :callType="type" :searchedKeyword="searchedKeyword" :filterFormData="filterForm"/>
                </h3>
            </div>
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-4">
                        <thead>
                            <tr class="fw-bolder border-0 text-muted bg-light">
                                ...
                                <th class="min-w-120px">Department Owner</th>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <delete-section permission="delete_business"
                                                :url="route('government.dashboard.departments.destroy', [getSelectedModuleValue(), business.uuid])"
...
export default {
    ...
    data () {
        return {
            ...
            type: 'business',
            logoUrl:'',
            urlForFilter: 'government.dashboard.departments.index',
            filterForm  : {
    ...
    methods: {
        changeStatus (business) {
            ...
            this.swal.fire({
                ...
                if (result.value) {
                    showWaitDialog()
                    this.$inertia.visit(route('government.dashboard.department.status', [this.getSelectedModuleValue(), business.id]), {
