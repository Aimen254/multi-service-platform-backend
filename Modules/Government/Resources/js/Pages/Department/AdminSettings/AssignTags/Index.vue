<template>
    <Head title="Department Tags" />
    <BreezeAuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Department Tags`" :path="`Departments - Admin Settings`" />
        </template>
                ...
                <div class="mb-5 mb-xl-8">
                    <div class="mt-6 ms-9">
                        <div class="card-title flex-column">
                            <h2 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Department tags</h2>
                        </div>
                    </div>
                    <div class="card-body">
...
export default {
    ...
    methods: {
        assignGlobalTags(id) {
            ...
            this.$inertia.visit(route("government.dashboard.department.assign.standard-tags", [this
        ...
        removeProductTags(tags) {
            window.axios.post(route('government.dashboard.department.remove-product-tags', [this.getSelectedModuleValue(), this.business.uuid]) , 
            {
        ...
        fetchSuggestions() {
             window.axios.get(route('government.dashboard.department.business-level-three-tags', [this.getSelectedModuleValue(), this.business.uuid]) , 
            {
                params: {
