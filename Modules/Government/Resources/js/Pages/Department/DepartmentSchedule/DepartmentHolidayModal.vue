                ...
                <div class="row fv-row mb-4 fv-plugins-icon-container">
                    <div class="col-md-12">
                        ...
                        <Input id="title" type="text"
                            :class="{'is-invalid border border-danger' : error && errors.title}" v-model="form.title"
    ...
    props: ['business'],
        ...
        methods: {
            ...
            submit() {
                ...
                this.loading = true;
                if (this.type == 'post') {
                    window.axios.post(route('government.dashboard.department.departmentholidays.store', [this.getSelectedModuleValue(), this.business.uuid]), this.form)
                        .then((response) => {
                            this.reset();
                    ...
                    this.form.date = this.days;
                    window.axios.put(route('government.dashboard.department.departmentholidays.update', [this.getSelectedModuleValue(), this.form.id, this.business.uuid]), this.form)
                        .then((response) => {
                            this.reset();
                            this.businessHolidays = response.data.businessHolidays;
                            this.$emit('childToParentHolidayModel', this.businessHolidays);
