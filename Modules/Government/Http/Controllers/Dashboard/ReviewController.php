...
class ReviewController extends Controller
{
    ...
    public function index($moduleId, $businessUuid)
    {
        ...
        return Inertia::render('Government::Department/Review/Index', [
            'business' => $business,
            'reviews' => $reviews,
            'title' => 'Reviews',
    ...
    public function destroy($moduleId, $id, $businessId,Request $request)
    {
        try {
            ...
            if ($currentCount > 1) {
                ...
                return Redirect::route('government.dashboard.department.reviews.index', [$moduleId,$businessId, 'page' => $previousPage]);
            }
