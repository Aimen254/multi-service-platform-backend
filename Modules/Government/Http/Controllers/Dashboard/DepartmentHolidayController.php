...
class DepartmentHolidayController extends Controller
{
    /**
    ...
    public function store(BusinessHolidayRequest $request)
    {
        try {
            ...
            return response()->json([
                'message' => 'Department Holiday Added!',
    ...
    public function update(BusinessHolidayRequest $request, $moduleId,  $id)
    {
        try {
            ...
            DB::commit();
            return response()->json([
                'message' => 'Department Holiday Updated!',
                'businessHolidays' => $businessHolidays
            ], JsonResponse::HTTP_OK);
        } catch (ModelNotFoundException $e) {
            DB::rollBack();
            return response()->json([
                'message' => 'Unable to find this Department Holiday'
    ...
    public function destroy($moduleId, $id)
    {
        try {
            ...
            return response()->json([
                'businessHolidays' => $businessHolidays,
                'message' => 'Department Holiday Deleted!'
            ], JsonResponse::HTTP_OK);
        } catch (ModelNotFoundException $e) {
            return response()->json([
                'message' => 'Unable to find this Department Holiday'
