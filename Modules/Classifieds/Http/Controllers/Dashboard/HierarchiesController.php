...
use Modules\Classifieds\Http\Requests\TagHierarchyRequest;
...
class HierarchiesController extends Controller
{
    ...
    public function index(Request $request, $module_id, $level)
    {
        ...
        return Inertia::render('Classifieds::TagHierarchy/Index', [
     ...
     *
     * @param TagHierarchyRequest $request
     * @param int $module_id
     * @param string $level
     * @return Renderable
     */
     ...
     * @return string
     */
    public function getRelationName($level): string
    {
        switch ($level) {
            case 2:
                return "levelTwo";
