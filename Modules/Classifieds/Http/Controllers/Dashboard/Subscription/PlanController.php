...
namespace Modules\Classifieds\Http\Controllers\Dashboard\Subscription;
...
class PlanController extends Controller
{
    ...
    public function index($moduleId)
    {
        ...
        return Inertia::render('Classifieds::Subscription/Plans/Index', [
    ...
    {
        return Inertia::render('Classifieds::Subscription/Plans/Edit', []);
    }
    ...
    public function update(SubscriptionPlanRequest $request, $moduleId, $id)
    {
        try {
            ...
            return \redirect()->route('classifieds.dashboard.subscription.plan.index', $moduleId);
        } catch (\Stripe\Exception\CardException $e) {
            flash($e->getMessage(), 'danger');
            return \redirect()->back();
        } catch (\Stripe\Exception\InvalidRequestException $e) {
