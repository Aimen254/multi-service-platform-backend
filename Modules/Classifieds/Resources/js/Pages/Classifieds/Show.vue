<template>
    <Head title="Classified Detail" />
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`View Classified`" :path="`Classifieds - ${limit(product?.name, 36)}`" />
        </template>
        <div>
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-5 justify-content-between">
                            <div class="card-title">
                                <h2 class="text-center">Classified Detail</h2>
                            </div>
                            <div>
                                    <span
                        ...
                        <div class="card-body pt-6">
                            <div class="row">
                                ...
                                <div class="col-md-9 d-flex mt-3">
                                    ...
                                    <span class="text-gray-800 fs-5 d-flex align-items-center px-3">{{ product?.name
                                    }}</span>
                                </div>
                                ...
                                <div class="col-md-9 mt-3 d-flex align-items-center">
                                    <span class="fw-normal fw-bold text-muted d-block fs-7">{{ product?.price ?? 'N/A'
                                    }}</span>
                                </div>
                                ...
                                <div class="col-md-9 mt-3 d-flex align-items-center">
                                    <span class="fw-normal fw-bold text-muted d-block fs-7">{{ product?.stock ?? 'N/A'
                                    }}</span>
                                </div>
                                ...
                                <div class="col-md-9 mt-3 d-flex align-items-center">
                                    <span class="fw-normal fw-bold text-muted d-block fs-7">{{ product?.weight ?
                                        product?.weight + ' ' + product?.weight_unit : 'N/A' }}</span>
                                </div>
                                ...
                                <div class="col-md-9 mt-3">
                                    <span class="fw-normal fw-bold text-muted d-block fs-7">{{
                                        formatDate(product.created_at) ?? 'N/A' }}</span>
                                </div>
                            </div>
                        </div>
                        <!--end::Body-->
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <delete-section permission="delete_comment"
                                                        :url="route('classifieds.dashboard.classifieds.comments.destroy', [getSelectedModuleValue(), product.uuid, comment.id])" />
                                                </div>
                                            </td>
                                        </tr>
                                    </template>
...
import CommentModal from '../Classifieds/Comments/Modal.vue';
