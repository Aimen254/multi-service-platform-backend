<template>
    <Head title="Classified Reviews" />
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Classified reviews`" :path="`Classified -${product?.name}`" />
        </template>
        <div class="d-flex flex-column flex-lg-row">
            <ClassifiedSidebar :classified="product" style="width: 25%!important;" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    :url="route('classifieds.dashboard.classifieds.reviews.destroy',[getSelectedModuleValue(),product.uuid, review.id])" />
                                                </div>
                                            </td>
                                        </tr>
                                    </template>
