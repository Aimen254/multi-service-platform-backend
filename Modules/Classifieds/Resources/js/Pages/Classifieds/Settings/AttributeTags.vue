<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="d-flex flex-column flex-lg-row">
            <ProductSidebar :classified="product" style="width: 25%!important;"/>
...
import ProductSidebar from '../Partials/ClassifiedSideMenu.vue'
...
export default {
    ...
    methods: {
        submit () {
            ...
            this.form.get(route("classifieds.dashboard.classifieds.attribute-tags.assign", [this
        ...
        fetchSuggestions(event) {
            ...
            window.axios
            .get(
                route("classifieds.dashboard.classifieds.search.attribute.tags", [
