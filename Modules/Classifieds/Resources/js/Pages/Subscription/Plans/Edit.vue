        ...
        <form class="mb-4" v-if="form" @submit.prevent="submit">
            <div class="card mb-5">
                <div class="card-header">
                    <div class="card-title fs-3 fw-bold" v-if="form?.id">Edit Plan</div>
                    <div class="card-title fs-3 fw-bold" v-else>Create Plan</div>
                </div>
                <div class="card-body py-3 pt-10">
                    ...
                    <div class="fv-row mb-4 fv-plugins-icon-container">
                        ...
                        <textarea class="form-control form-control-lg form-control-solid" rows="4"
                            placeholder="Policy" v-model="form.description"
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 ">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="form-check form-check-sm form-check-custom form-check-solid">
                                        <input class="form-check-input widget-9-check" id="totalAllowedProducts" type="checkbox"
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column"
                                            ...
                                            <label for="totalAllowedProducts" class="text-dark fw-bold text-hover-primary fs-6 cursor-pointer">Total Allowed
                                                Classifieds</label>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="form-check form-check-sm form-check-custom form-check-solid">
                                        <input class="form-check-input widget-9-check" id="subscriptionType" type="checkbox"
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column"
                                            style="margin-right:550px;">
                                            <label for="subscriptionType" class="text-dark fw-bold text-hover-primary fs-6 cursor-pointer">Subscription Type</label>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-end">
                            ...
                            <tr>
                                <td>
                                    <div class="form-check form-check-sm form-check-custom form-check-solid">
                                        <input class="form-check-input widget-9-check" id="featuredProducts" type="checkbox"
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column"
                                            style="margin-right:550px;">
                                            <label for="featuredProducts" class="text-dark fw-bold text-hover-primary fs-6 cursor-pointer">Featured Classifieds</label>
...
export default {
    ...
    methods: {
        async submit() {
            ...
            if (this.form.id) {
                this.form.put(route('classifieds.dashboard.subscription.plan.update', [this.getSelectedModuleValue(), this.form.id]), {
                    errorBag: null,
                ...
                this.form.post(route('classifieds.dashboard.subscription.plan.store', [this.getSelectedModuleValue()]), {
                    errorBag: null,
                    preserveScroll: false,
                    onSuccess: () => {
                        this.processing = false
