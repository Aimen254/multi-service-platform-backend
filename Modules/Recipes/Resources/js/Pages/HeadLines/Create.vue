<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Create HeadLine`" :path="`Recipes - HeadLine`" />
        </template>
        <div>
            <div v-if="filterForm">
                <!--begin::Layout-->
            ...
            <div :class="widgetClasses" class="card">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">
                            <RecipesSearchInput :callType="'headLineFilter'" :filterFormData="filterForm"
                ...
                <div v-if="recipes">
                    ...
                    <!--begin::Body-->
                    <pagination :meta="recipes" :keyword="searchedKeyword" :callType="'headLineFilter'"
...
export default {
    props: ['levelTwoTags', 'recipesList', 'type', 'tag', 'searchedKeyword'],
    components: {
        Head,
        AuthenticatedLayout,
        Breadcrumbs,
    ...
    methods: {
        featchProducts() {
            ...
            this.$inertia.visit(route('recipes.dashboard.headlines.create', this.getSelectedModuleValue()), {
                data: {
        ...
        makeHeadLine(product) {
            this.swal.fire({
                ...
                if (result.value) {
                    showWaitDialog()
                    window.axios.post(route('recipes.dashboard.headlines.store', this.getSelectedModuleValue()), {
                        type: this.filterForm.type,
