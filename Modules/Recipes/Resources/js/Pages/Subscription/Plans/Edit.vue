                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column"
                                            style="margin-right:550px;">
                                            <a href="#" class="text-dark fw-bold text-hover-primary fs-6">Featured Recipes</a>
                                            <!-- <span class="text-muted fw-semibold text-muted d-block fs-7">xyz</span> -->
                                        </div>
                                    </div>
                                </td>
...
export default {
    ...
    methods: {
        async submit() {
            ...
            if (this.form.id) {
                this.form.put(route('recipes.dashboard.subscription.plan.update', [this.getSelectedModuleValue(), this.form.id]), {
                    errorBag: null,
                ...
                this.form.post(route('recipes.dashboard.subscription.plan.store', [this.getSelectedModuleValue()]), {
                    errorBag: null,
                    preserveScroll: false,
                    onSuccess: () => {
                        this.processing = false
