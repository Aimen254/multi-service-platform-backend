<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Create Recipes`" :path="`Recipes - Recipes`" />
        </template>
        <div>
                                ...
                                <div class="row mb-4 fv-plugins-icon-container">
                                    <div class="col-lg-6 py-2">
                                        ...
                                        <Input id="name" type="text" v-model="form.name"
                                            ...
                                            autocomplete="name" placeholder="Enter recipe title" />
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        ...
                                        <QuillEditor theme="snow" v-model:content="form.description" contentType="html"
                                            placeholder='Compose recipe description...' />
...
export default {
    ...
    methods: {
        submit() {
            ...
            this.form.post(route('recipes.dashboard.recipes.store', this.getSelectedModuleValue()), {
                errorBag: 'recipes',
                preserveScroll: true,
                onError: (errors) => {
