<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`View Recipe`" :path="`Recipes - ${limit(product?.name, 36)}`" />
        </template>
        <div>
            <div class="row gx-5 gx-xl-10">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-5">
                            <div class="card-title">
                                <h2 class="text-center">Recipe Detail</h2>
                            </div>
                        </div>
                        <!--end::Header-->
                ...
                product.name }}</span>
                                ...
                                <div class="col-md-9 mt-3">
                                    <span class="fw-normal fw-bold text-muted d-block fs-7">{{ product.user.first_name
                                        }}
                                        {{
                product.user.last_name }}</span>
                                </div>
                ...
                <div class="card">
                    <div class="card-header border-0 pt-5">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <h3 class="card-title align-items-start flex-column">
                                <RecipesSearchInput :module="module" :callType="type" :searchedKeyword="searchedKeyword"
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <delete-section permission="delete_comment"
                                                        :url="route('recipes.dashboard.recipes.comments.destroy',[getSelectedModuleValue(),product.uuid, comment.id])" />
                                                </div>
                                            </td>
                                        </tr>
                                    </template>
...
import CommentModal from '../Recipes/Comments/Modal.vue';
