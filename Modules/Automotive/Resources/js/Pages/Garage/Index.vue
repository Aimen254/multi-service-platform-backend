<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`All Dealerships`" :path="`Dealerships`" />
            ...
            <Link :href="route('automotive.dashboard.dealership.create', getSelectedModuleValue())" v-if="checkUserPermissions('add_business')" class="btn btn-sm btn-primary">
        ...
        <div class="card">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <AutomotiveSearchInput :callType="type" :searchedKeyword="searchedKeyword" :filterFormData="filterForm"/>
                </h3>
            </div>
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-4">
                        <thead>
                            <tr class="fw-bolder border-0 text-muted bg-light">
                                ...
                                <th class="min-w-120px">Dealership Owner</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge fs-7 fw-bold text-capitalize"
                                            :class="{ 'badge-light-success': business.status == 'active', 'badge-light-danger': business.status === 'inactive' }">{{ business.status }}
                                        </span>
                                    </td>
                                    <td>
                                        <span
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <delete-section permission="delete_business"
                                                :url="route('automotive.dashboard.dealership.destroy', [getSelectedModuleValue(), business.uuid])"
...
import AutomotiveSearchInput from "../../Components/AutomotiveSearchInput.vue";
...
export default {
    ...
    data () {
        return {
            ...
            type: 'dealership',
            logoUrl:'',
            urlForFilter: 'automotive.dashboard.dealership.index',
            filterForm  : {
    ...
    methods: {
        changeStatus (business) {
            ...
            this.swal.fire({
                ...
                if (result.value) {
                    showWaitDialog()
                    this.$inertia.visit(route('automotive.dashboard.dealership.status', [this.getSelectedModuleValue(), business.id]), {
