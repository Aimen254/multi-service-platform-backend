<template>
    ...
    <AuthenticatedLayout>
        ...
        <template #breadcrumbs>
            <Breadcrumbs :title="`Reviews`" :path="`Dealerships`" />
        </template>
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">
                        <AutomotiveSearchInput :business="business" :callType="type" :searchedKeyword="searchedKeyword"/>
                    </span>
                </h3>
            </div>
            <!--end::Header-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            :url="route('automotive.dashboard.dealership.reviews.destroy', [getSelectedModuleValue(), review.id, business.id])" 
        ...
        changeStatus(id) {
            this.swal.fire({
                ...
                if (result.value) {
                    ...
                    this.$inertia.visit(route('automotive.dashboard.dealership.review.status', [this.getSelectedModuleValue(), id, this.business.id]), {
