<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Create Dealership`" :path="`Dealerships`" :subTitle="`Create Dealership`"></Breadcrumbs>
        </template>
        <div class="card pt-5">
...
export default {
    ...
    methods: {
        submit() {
            this.form.post(route('automotive.dashboard.dealership.store', this.getSelectedModuleValue()), {
                errorBag: 'business',
