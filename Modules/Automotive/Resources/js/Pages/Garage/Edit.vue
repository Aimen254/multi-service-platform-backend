<template>
    <Head title="Edit dealership" />
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Edit Dealership`" :path="`Dealerships`" :subTitle="`Edit Dealership`"></Breadcrumbs>
        </template>
        <!-- cover, thumbnail, logo section -->
        <div class="bg-white ps-2 pt-4 rounded">
            <image-section :business="business" :token="token" :mediaLogoSizes="mediaLogoSizes" :mediaBannerSizes="mediaBannerSizes" :mediaSecondaryBannerSizes="mediaSecondaryBannerSizes"></image-section>
        </div>
        <div class="card pt-5">
...
export default {
    ...
    methods: {
        submit() {
            this.form.put(route('automotive.dashboard.dealership.update', [this.getSelectedModuleValue(), this.business.uuid]), {
                errorBag: 'business',
