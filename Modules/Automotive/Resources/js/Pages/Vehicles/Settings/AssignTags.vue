                        ...
                        <div class="card-body py-3 row">
                            ...
                            <div class="fv-row mb-4 fv-plugins-icon-container">
                                ...
                                <TagComponent placeholder="Extra Tags" :uuid="product.uuid" :assignedTags="extraTag"
                                    :autocomplete="filteredAllTags" :onlyFromAutoComplete="false" :openOnClick="false"
                                    :tooltipContent="'Unmapped Tags Information.'" />
                                <error :message="form.errors.tags" />
                            </div>
                            <div class="fv-row mb-4 fv-plugins-icon-container">
                                <Label value="Ignored Tags" />
                                <TagComponent @click="removeTooltip" placeholder="Ignored Tags" :uuid="product.uuid"
                                    :assignedTags="ignoredTags" :autocomplete="allIgnoredAutocomplete"
                                    :onlyFromAutoComplete="false" :openOnClick="true"
                                    :tooltipContent="'Ignored Inappropriate Tags.'" />
                                <error :message="form.errors.tags" />
                            </div>
...
export default {
    ...
    methods: {
        submit() {
            ...
            this.form.get(route("automotive.dashboard.vehicle.vehicle-tags.assign", [this
