...
class VehicleMediaController extends Controller
{
    ...
    // {
    //     $this->middleware(\App\Http\Middleware\VerifyCsrfToken::class)->except('store');
    // }
    ...
    public function index($moduleId, $uuid)
    {
        ...
        return Inertia::render('Automotive::Vehicles/Settings/VehiclesMedia', [
            'product' => $product,
    ...
    public function update(Request $request, $moduleId, $uuid, $id = null)
    {
        ...
        try {
            ...
            flash('Vehicle main image updated successfully.', 'success');
