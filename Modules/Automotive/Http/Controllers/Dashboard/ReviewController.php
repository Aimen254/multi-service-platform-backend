...
class ReviewController extends Controller
{
    ...
    public function index($moduleId, $businessUuid)
    {
        ...
        return Inertia::render('Automotive::Garage/Review/Index', [
            'business' => $business,
            'reviews' => $reviews,
            'title' => 'Reviews',
    ...
    public function destroy($moduleId, $id,$businessId,Request $request)
    {
        try {
            ...
            if ($currentCount > 1) {
                ...
                return Redirect::route('automotive.dashboard.dealership.reviews.index', [$moduleId,$businessId, 'page' => $previousPage]);
            }
