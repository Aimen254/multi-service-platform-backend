                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-4">
                        <thead>
                            <tr class="fw-bolder border-0 text-muted bg-light">
                                <th class="ps-4 min-w-120px rounded-start">Service</th>
                        ...
                        <tbody v-if="contactForms && contactForms.data.length > 0">
                            <template v-for="form in contactForms.data" :key="form.id">
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <view-section permission="view_contact_form" :url="route('services.dashboard.service-provider.communication-portal.show', [getSelectedModuleValue(), getSelectedBusinessValue(), form.id])"/>
                                            ...
                                            <delete-section permission="delete_contact_form"
                                                :url="route('services.dashboard.service-provider.communication-portal.destroy', [getSelectedModuleValue(), getSelectedBusinessValue(), form.id])" 
