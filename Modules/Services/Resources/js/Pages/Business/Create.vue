<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Create Service Provider`" :path="`Service Provider`"
                :subTitle="`Create Service Provider`"></Breadcrumbs>
        </template>
        <div class="card pt-5">
                        ...
                        <!-- <div class="col-lg-6 fv-row mb-2 fv-plugins-icon-container">
                            <div class="form-check pt-5">
                                <input class="form-check-input" type="checkbox" value=""
                                    :checked="form.home_delivery" v-model="form.home_delivery" />
...
export default {
    ...
    methods: {
        submit() {
            this.form.post(route('services.dashboard.service-provider.store', this.getSelectedModuleValue()), {
                errorBag: 'business',
