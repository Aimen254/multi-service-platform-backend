<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Edit Service`" :path="`Services - ${limit(form?.name, 36)}`" />
        </template>
                            ...
                            <div class="row" style="margin-top: 12%;">
                                <div class="col-lg-6 py-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="CheckIsFeatured"
                                            :checked="form.is_featured" v-model="form.is_featured" />
                                        <label class="form-check-label" for="CheckIsFeatured">
                                            Featured ?
                                        </label>
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        submit() {
            this.form.put(route('services.dashboard.service-provider.services.update', [this.getSelectedModuleValue(), this.getSelectedBusinessValue(), this.product.uuid]), {
                errorBag: "product",
                preserveScroll: true,
            });
        },
        ...
        getLevelThreeTags(tag, level) {
            ...
            setTimeout(() => {
                ...
                // selected value
                window.axios.get(route('services.dashboard.service-provider.services.tags', [this.getSelectedModuleValue(), this.getSelectedBusinessValue(), tag, level]), {
                    params: {
