<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Services`" :path="`Services`" />
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <Link v-if="checkUserPermissions('add_products')"
                    :href="route('services.dashboard.service-provider.services.create', [getSelectedModuleValue(), getSelectedBusinessValue()])"
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <edit-section iconType="link" permission="edit_products"
                                                :url="route('services.dashboard.service-provider.services.edit', [getSelectedModuleValue(), getSelectedBusinessValue(), product.uuid])" />
                                            <delete-section permission="delete_products"
                                                :url="route('services.dashboard.service-provider.services.destroy', [getSelectedModuleValue(), getSelectedBusinessValue(), product.uuid])" 
...
export default {
    ...
    data() {
        return {
            ...
            type: 'services',
            urlForFilter: 'services.dashboard.service-provider.services.index',
            filterForm: {
        ...
        changeStatus(uuid) {
            this.swal.fire({
                ...
                if (result.value) {
                    ...
                    this.$inertia.visit(route('services.dashboard.service-provider.services.status', [this.getSelectedModuleValue(), this.getSelectedBusinessValue(), uuid]), {
