...
class NewsHierarchyTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        function newsStandardTags($data, $news, $level) {
            foreach ($data as $item) {
                ...
                if (isset($item['children'])) {
                    $newLevel[] = $tags->id;
                    newsStandardTags($item['children'], $news, $newLevel);
                } else {
                    $newLevel[] = $tags->id;
