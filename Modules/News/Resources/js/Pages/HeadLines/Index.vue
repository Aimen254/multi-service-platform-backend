<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`News`" :path="`HeadLines`" />
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <Link v-if="checkUserPermissions('add_headlines')" @click="removeHedinLineType()"
                    :href="route('news.dashboard.headlines.create', this.getSelectedModuleValue())"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <delete-section iconType="link" permission="delete_headlines"
                                            ...
                                            :url="route('news.dashboard.headlines.destroy', [getSelectedModuleValue(), item.headline?.id])" 
