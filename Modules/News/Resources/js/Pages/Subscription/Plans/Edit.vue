                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 ">
                        ...
                        <thead>
                            <tr class="fw-bold text-muted">
                                ...
                                <th class="min-w-150px text-end">Enter Quantityy</th>
                            </tr>
                        </thead>
                        <!--end::Table head-->
                        <!--begin::Table body-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column"
                                            style="margin-right:550px;">
                                            <a href="#" class="text-dark fw-bold text-hover-primary fs-6">Featured News</a>
                                            <!-- <span class="text-muted fw-semibold text-muted d-block fs-7">xyz</span> -->
                                        </div>
                                    </div>
                                </td>
...
export default {
    ...
    methods: {
        async submit() {
            ...
            if (this.form.id) {
                this.form.put(route('news.dashboard.subscription.plan.update', [this.getSelectedModuleValue(), this.form.id]), {
                    errorBag: null,
                ...
                this.form.post(route('news.dashboard.subscription.plan.store', [this.getSelectedModuleValue()]), {
                    errorBag: null,
                    preserveScroll: false,
                    onSuccess: () => {
                        this.processing = false
