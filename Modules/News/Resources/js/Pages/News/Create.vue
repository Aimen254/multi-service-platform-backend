<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs :title="`Create News`" :path="`News - News`" />
        </template>
        <div>
                        ...
                        <div class="card mb-5 mb-xl-8">
                            <div class="card-body">
                                ...
                                <div class="row mb-4 mt-8">
                                    <Label for="image" value="Image"  class="required"/>
                                ...
                                <div class="row mb-4 fv-plugins-icon-container">
                                    <div class="col-lg-6 py-2">
                                        ...
                                        <Input id="name" type="text" v-model="form.name"
                                            ...
                                            autocomplete="name" placeholder="Enter news title" />
...
export default {
    ...
    methods: {
        submit() {
            ...
            this.form.post(route('news.dashboard.news.store', this.getSelectedModuleValue()), {
                errorBag: 'news',
                preserveScroll: true,
                onError: (errors) => {
