                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-end">
                                    <Input id="price" type="number" class="text-end" :disabled="!permissions.total_products.status" :class="{ 'is-invalid border border-danger': form.errors['permissions.total_products.value'] }"
...
export default {
    ...
    methods: {
        async submit() {
            ...
            if (this.form.id) {
                this.form.put(route('obituaries.dashboard.subscription.plan.update', [this.getSelectedModuleValue(), this.form.id]), {
                    errorBag: null,
                ...
                this.form.post(route('obituaries.dashboard.subscription.plan.store', [this.getSelectedModuleValue()]), {
                    errorBag: null,
                    preserveScroll: false,
                    onSuccess: () => {
                        this.processing = false
