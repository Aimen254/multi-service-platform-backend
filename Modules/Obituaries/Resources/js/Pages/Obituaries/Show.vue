<template>
    <Head title="Obituary Detail" />
    <AuthenticatedLayout>
        <template #breadcrumbs>
            <Breadcrumbs title="View Obituary" :path="`Obituaries - ${limit(product?.name, 36)}`" />
        </template>
        <div>
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-5">
                            <div class="card-title">
                                <h2 class="text-center">Obituary Detail</h2>
                            </div>
                        </div>
                        <!--end::Header-->
                        ...
                        <div class="card-body pt-6">
                            <div class="row">
                                ...
                                <div class="col-md-9 d-flex mt-3">
                                    ...
                                    <span class="text-gray-800 fs-5 d-flex align-items-center px-3">{{ product?.name}}</span>
                                </div>
                                ...
                                <div class="col-md-9 mt-3">
                                    <div>
                                        <span class="fw-normal fw-bold text-muted d-block fs-7" v-html="displayedDescription"></span>
                                ...
                                <div class="col-md-9 mt-3">
                                    <span class="fw-normal fw-bold text-muted d-block fs-7">{{ product?.user?.first_name}} {{ product?.user?.last_name}}</span>
                                </div>
                                <div class="col-md-3 mt-3">
                                    <h4>Created At:</h4>
                                </div>
                                <div class="col-md-9 mt-3">
                                    <span class="fw-normal fw-bold text-muted d-block fs-7">{{ formatDate(product?.created_at) ?? 'N/A' }}</span>
                                </div>
                                ...
                                <div class="col-md-9 mt-3 d-flex align-items-center">
                                    <span class="fw-normal fw-bold text-muted d-block fs-7">{{ formatDate(product?.date_of_birth) ?? 'N/A' }}</span>
                                </div>
                                <div class="col-md-3 mt-3">
                                    <h4>Date Of Death:</h4>
                                </div>
                                <div class="col-md-9 mt-3 d-flex align-items-center">
                                    <span class="fw-normal fw-bold text-muted d-block fs-7">{{ formatDate(product?.date_of_death) ?? 'N/A' }}</span>
                                </div>
                            </div>
                        </div>
                        <!--end::Body-->
            ...
            <div class="">
                ...
                <div class="card">
                    <div class="card-header border-0 pt-5">
                        <h4>Comments <span v-if="product?.is_commentable === 0" style="font-size: 10px; color: #6c757d;">&#40;Comments are turned off&#41;</span></h4>
                        <h3 class="card-title align-items-start flex-column">
                            <h3 class="card-title align-items-start flex-column">
                                <ObituariesSearchInput :module="module" :callType="type" :searchedKeyword="searchedKeyword"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-muted fw-bold d-block fs-7 text-capitalize">
                                                    <span class="fw-normal text-muted fs-7">{{ comment.comment && comment.comment.length > count ? comment.comment.slice(0, count) + '...' : comment.comment }}</span>
                                                </span>
                                            </td>
                                            <td>
                                                <span class="text-muted fw-bold d-block fs-7 text-capitalize">
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    :url="route('obituaries.dashboard.obituaries.comments.destroy',[getSelectedModuleValue(), product.uuid, comment.id])" />
                                                </div>
                                            </td>
                                        </tr>
                                    </template>
