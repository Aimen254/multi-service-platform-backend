...
<div style="padding:4%; border-radius:4px">
    ...
    <div style="text-align: center; font-weight:600">({{$user->first_name. ' ' . $user->last_name}}) thankyou for your
        order!</div>
    <div style="text-align: center">
        <div style="text-align: center; font-weight:600; margin-inline:10%">We've received your order and we will
            further inform you about
            <span style="color: coral">{{$order->business->name}}</span> response. You can find your order information
            below.</div>
    </div>
</div>
