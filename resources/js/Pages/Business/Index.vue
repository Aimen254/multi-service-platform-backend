<template>
    ...
    <AuthenticatedLayout>
        <template #breadcrumbs>
            ...
            <Link :href="route('dashboard.businesses.create')" v-if="checkUserPermissions('add_business') && getSelectedModuleValue() == 'settings'" class="btn btn-sm btn-primary">
        ...
        <div class="card">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <SearchInput :callType="type" :searchedKeyword="searchedKeyword" :filterFormData="filterForm "/>
                </h3>
            </div>
...
export default {
    ...
    data () {
        return {
            ...
            type: 'business',
            logoUrl:'',
            urlForFilter: 'dashboard.businesses.index',
            filterForm  : {
