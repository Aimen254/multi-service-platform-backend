        ...
        <div class="card card-flush pt-3 mb-5 mb-lg-10" data-kt-subscriptions-form="pricing">
            ...
            <div class="card-body pt-0">
                <div id="kt_create_new_payment_method">
                    <div class="py-1" v-for="(card, index) in creditCards" :key="index">
                        <div class="py-3 d-flex flex-stack flex-wrap">
                            <div class="d-flex align-items-center collapsible toggle collapsed" data-bs-toggle="collapse"
                                :data-bs-target="`#kt_create_new_payment_method_${index}`" aria-expanded="false">
                                <div class="btn btn-sm btn-icon btn-active-color-primary ms-n3 me-2">
                                    <span class="svg-icon toggle-on svg-icon-primary svg-icon-2">
                                        <svg fill="none" viewBox="0 0 24 24" height="24" width="24"
                                            ...
                                            <rect xmlns="http://www.w3.org/2000/svg" opacity="0.3" x="2" y="2" width="20"
                                ...
                                <div class="me-3">
                                    <div class="d-flex align-items-center fw-bold text-capitalize">
                                        {{ card.brand }}
                                        <div class="badge badge-light-primary ms-5" v-if="card.default">Primary</div>
                                    </div>
                                    <div class="text-muted">
                                        Expires {{ getMonth(card.expiry_month) }} {{
                                            card.expiry_year }}
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex my-3 ms-9">
                                <label class="form-check form-check-custom form-check-solid me-5">
                                    <input class="form-check-input" type="radio" name="payment_method"
                                        :checked="card.default" :value="card.payment_method_id" v-model="this.data.card">
                                </label>
                            </div>
                        </div>
                                                    ...
                                                    <span class="svg-icon svg-icon-2 svg-icon-success">
                                                        <svg fill="none" viewBox="0 0 24 24" height="24" width="24"
                                                            ...
                                                            <rect xmlns="http://www.w3.org/2000/svg" opacity="0.3" x="2"
                                                                y="2" width="20" height="20" rx="10" fill="currentColor">
                                                            </rect>
            ...
            <div class="card-header">
                ...
                <div class="fv-row mb-4 fv-plugins-icon-container">
                    ...
                    <select class="form-select form-select-solid" name="interval" id="interval"
                        :class="{ 'is-invalid border border-danger': false }" v-model="selectedModule"
                        @change="getPlans($event)">
                    ...
                    <div class="row row-cols-3 g-5">
                        <div class="col" v-for="(plan, index) in subscriptionPlans" :key="index">
                            <div class="d-flex h-100 align-items-center">
                                <div class="w-100 d-flex flex-column flex-center rounded-3 bg-light bg-opacity-75 pt-4 pb-15 px-10">
                                    <span class="badge badge-light-success mb-3" style="margin-left: 48%;" v-if="plan.currentPlan">Subscription Active</span>
                                    <span v-else class="mb-3" style="color:#f8fafb">.</span>
...
export default {
    ...
    data() {
        return {
            ...
            modulesArray: ['news', 'posts', 'obituaries', 'blogs', 'recipies']
        }
    },
    ...
    methods: {
        ...
        upgradeSubscription(plan) {
            ...
            this.swal.fire({
                ...
                if (result.value) {
                    if(this.modulesArray.includes(this.selectedModule)) {
                        showWaitDialog()
